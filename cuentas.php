...
if ($_POST) {
    ...
    switch ($accion) {
            ...
            case 'editar':
                ...
                // Solo permitir editar cuentas propias (para todos los usuarios)
                $stmt = $db->query(
            ...
            case 'eliminar':
                $id = intval($_POST['id']);
                // Verificar propiedad (para todos los usuarios)
...
// Obtener solo cuentas del usuario actual (para todos los usuarios)
$cuentas = $db->fetchAll(
    "SELECT c.*, 
